...
export default function ExternalAuctionBlock({
  ...
  return (
    <div
      className={`bg-base-100 px-5 py-2 rounded-3xl shadow-md shadow-secondary border border-base-300 flex flex-col gap-3 mb-2 ${className}`}
    >
      <div
      ...
      >
        <div className="font-bold text-xs sm:text-lg">
          Win {formatToken(BigInt(externalAuction.auctionAmount), tokenDecimals, displayDecimals)} ${tokenName}
        </div>
