    ...
    <div className="w-full max-w-3xl mx-auto px-2 sm:px-4 lg:px-6">
      <div className="flex flex-col gap-4 py-6">
        <div className="bg-base-100 p-6 rounded-3xl shadow-md shadow-secondary border border-base-300">
          <h2 className="text-2xl font-extrabold mb-2 text-primary">About FireBid Degen</h2>
          <p className="text-base leading-relaxed mb-3">
            FireBid Degen is an experiment miniApp, an implementation of fomo3d, powered by a smart contract on the Base
